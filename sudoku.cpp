/*
Given a partially filled 9×9 2D array ‘grid[9][9]’, the goal is 
...
digits starting from 1 up-till 9. 
*/
...
/* function that checks whether it will be
safe to assign num to the
given row and col */
